...
\\\\
Das Datenset fanden wir auf der Suche nach einem geeigneten Datensatz auf Kaggle, einer Plattform für Data Science und maschinelles Lernen.
...
In dem folgenden Code-Snippet wird gezeigt, wie der Datensatz von Kaggle heruntergeladen wurde:
...
\end{lstlisting}
In dem folgenden Code-Snippet wird gezeigt, wie die Bilder in Arrays und Labels eingeteilt werden, um sie für das Training und die Evaluierung des Modells vorzubereiten:
...
\begin{itemize}
    ...
    \item ROC Curve Erklärung: \url{https://en.wikipedia.org/wiki/Receiver_operating_characteristic}
    \item Chat GPT \textit{OpenAI} \url{https://chatgpt.com/}
\end{itemize}
