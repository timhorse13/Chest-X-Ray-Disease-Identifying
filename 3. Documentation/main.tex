...
\begin{itemize}
    \item MLP Classifier: \\ Einfach zu implementieren und schnell zu trainieren, geeignet für erste Tests.
...
\begin{lstlisting}[language=Python, caption=Evaluationscode MLP Classifier]
...
\begin{center}
\[
\text{Konfusionsmatrix MLP Classifier:}\quad
\begin{bmatrix}
680 & 139 & 106 \\
66 & 507 & 7 \\
366 & 3 & 695 \\
